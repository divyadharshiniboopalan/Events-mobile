...
const Total = (props) => {
    const TotalEventsData = props.route.params.totalEventsData
    ...
    return (
        <View style={{ flex: 1, backgroundColor: theme.colors.elevation.level0 }}>
            <TitleBar title={"Total Events"} onClick={() => navigation.goBack()} />
            <View style={{ flex: 8 }}>
                <View style={{}}>
...
// import { StyleSheet, Text, TouchableOpacity, View, Platform, ActivityIndicator, Image, ScrollView } from 'react-native'
// import { Card, useTheme } from 'react-native-paper'
// import { RNText } from '../components/RNText'
// import { MaterialCommunityIcons, MaterialIcons, AntDesign } from '@expo/vector-icons';
// import moment from 'moment';
...
// console.log("🚀 ~ deleteCalendar ~ id:", id)

//     const calendars = await Calendar.deleteCalendarAsync(id);
// }
...
//                             <TouchableOpacity key={i} style={{height:100,width:600,backgroundColor:"yellow",margin:5}} onPress={()=>deleteCalendar(e.id)}>
//                                 <RNText title={e.title}/>
//                             </TouchableOpacity>
//                         ))
//                     }
